    ...
    <div className='form-container border shadow p-5 rounded-4 bg-white w-50'>
      ...
      <form className='d-flex flex-column' onSubmit={handleSubmit}>
        ...
        <label htmlFor="email" className='form-label'>Email</label>
          ...
          <input type="email" className="form-control" name='email' value={value.email} onChange={handleChange} placeholder="Email" aria-label="Email" aria-describedby="basic-addon2"/>
        </div>
